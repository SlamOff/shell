...
gulp.task('autopolyfiller', function () {
    return gulp.src(['app/**/*.js', '!app/es6/*.js'])
        .pipe(autopolyfiller('polyfill.js'))
        .pipe(gulp.dest('app/polyfills'));
});

//css + js
gulp.task('build', ['clean', 'autopolyfiller'], function () {
